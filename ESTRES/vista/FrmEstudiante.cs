...
namespace ESTRES.vista
{
    public partial class FrmEstudiante : Form
    {
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            frmNuevoEstudiante.Show();
        }

        private void btnModificar_Click(object sender, EventArgs e)
        {
            FrmModificarEstudiante frmModificarEstudiante = new FrmModificarEstudiante();
            frmModificarEstudiante.Show();
        }

        private void btnEliminar_Click(object sender, EventArgs e)
        {
            FrmEliminarEstudiante frmEliminarEstudiante = new FrmEliminarEstudiante();
            frmEliminarEstudiante.Show();
        }
    }
}
