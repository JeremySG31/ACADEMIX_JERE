...
namespace ESTRES.vista
{
    public partial class FrmApoderado : Form
    {
        ...
        private void cbIdModificar_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txtIdApoderado.Text = fila["id"].ToString();
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ActualizarCampos();
                MessageBox.Show("Apoderado insertado correctamente.", "Éxito", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ActualizarCampos();
                MessageBox.Show("Apoderado modificado correctamente.", "Éxito", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
        ...
        {
            if (string.IsNullOrEmpty(txtIdApoderado.Text) ||
